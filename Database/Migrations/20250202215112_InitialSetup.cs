        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceName = table.Column<string>(type: "varchar", maxLength: 100, nullable: true, comment: "The source name of the request."),
                    OsVersion = table.Column<string>(type: "varchar", maxLength: 100, nullable: true, comment: "The operating system version of the client making the request."),
                    Host = table.Column<string>(type: "varchar", maxLength: 100, nullable: true, comment: "The hostname of the client."),
                    Username = table.Column<string>(type: "varchar", maxLength: 100, nullable: true, comment: "The username of the user making the request."),
                    DomainName = table.Column<string>(type: "varchar", maxLength: 100, nullable: true, comment: "The domain name associated with the request."),
                    Address = table.Column<string>(type: "varchar", maxLength: 100, nullable: true, comment: "The IP address of the client making the request."),
                    RequestMethod = table.Column<string>(type: "varchar", maxLength: 10, nullable: true, comment: "The HTTP method used in the request (e.g., GET, POST)."),
                    RequestPath = table.Column<string>(type: "varchar", maxLength: 100, nullable: true, comment: "The path of the requested resource."),
                    RequestTime = table.Column<string>(type: "datetime", nullable: true, comment: "The timestamp of when the request was made."),
                    RequestBody = table.Column<string>(type: "varchar", nullable: true, comment: "The body content of the request."),
                    RequestHeaders = table.Column<string>(type: "varchar", nullable: true, comment: "The headers included in the request."),
                    ResponseHeaders = table.Column<string>(type: "varchar", nullable: true, comment: "The headers included in the response."),
                    ResponseStatusCode = table.Column<string>(type: "varchar", maxLength: 10, nullable: true, comment: "The HTTP status code of the response."),
                    ResponseBody = table.Column<string>(type: "varchar", nullable: true, comment: "The body content of the response."),
                    RowVersion = table.Column<Guid>(type: "varchar", nullable: false, comment: "The version of the data entry."),
                    CreatedBy = table.Column<string>(type: "varchar", maxLength: 100, nullable: false, comment: "Who created the record."),
